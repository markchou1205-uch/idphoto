    ...
    try {
        ...
        if (data && data.length > 0) {
            ...
            if (faceW > targetPhotoW * 0.8) {
                ...
                // Width Constraint (Relaxed):
                // Only zoom out if face width exceeds 90% of photo width (Allowing ears to be close to edge)
                // Previous 0.80 was too conservative, causing "Head too small" (2.8cm).
                ...
                // Vertical Alignment
                // User Request: "Force shift up... Top margin approx 4.5mm".
                // Since rect.top is forehead, real HEAD TOP is higher.
                // Let's set the detected Forehead (rect.top) to be at approx 18% from top?
                // (10% margin + 8% forehead-to-hair).
                // This ensures standard 10% white space above hair.
