...
# Remove 'smile'. Keep 'glasses,occlusion'.
ENDPOINT = "https://my-face-check-01.cognitiveservices.azure.com/face/v1.0/detect?returnFaceAttributes=glasses,occlusion&detectionModel=detection_01&returnFaceId=false"
...
print(f"Testing w/o Smile: {ENDPOINT}")
